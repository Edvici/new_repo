...
require('require-environment-variables')(['GOOGLE_CLIENT_ID', 'GOOGLE_CLIENT_SECRET', 'SESSION_SECRET', 'ALLOWED_DOMAINS']) //, 'MEMCACHIER_SERVERS'])
...
passport.use(new GoogleStrategy(
  ...
  function(accessToken, refreshToken, profile, done) {
    if (allowedDomains.indexOf(profile._json.hd) > -1) {
